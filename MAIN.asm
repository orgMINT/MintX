; *************************************************************************
;
;       MINTX 1.0 Minimal Interpreter for the Z80 
;
...
; **************************************************************************		
	...
	.ORG ROMSTART + $180		; 0+180 put MINTX code from here	

; **************************************************************************
; Macros must be written in MINTX and end with ; 
...
iAltCodes:
    ...
    db     lsb(go_)         ;G      go execute MINTX code
    db     lsb(aNop_)       ;H
    ...
    db     lsb(prompt_)     ;P      print MINTX prompt
    db     lsb(aNop_)       ;Q
    db     lsb(aNop_)       ;R
...
macro:                          
    ld (vTIBPtr),bc
    push de
    call ENTER		;MINTX go operation and jump to it
    .cstr "/G"
    ld bc,(vTIBPtr)
    jr interpret2
